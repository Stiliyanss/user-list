...
export default function UserInfo(props) {
  ...
  useEffect(()=>{
    userService.getOne(props.userId)
          ...
          <div className="content">
            ...
            <div className="user-details">
              ...
              <p>Created on: <strong>{user.createdAt && new Date(user.createdAt)
                .toLocaleString("en-US", { year: "numeric", month: 'long', day: "numeric" })}</strong></p>

            <p>Modified on: <strong>{user.updatedAt && new Date(user.updatedAt)
              .toLocaleString("en-US", { year: "numeric", month: 'long', day: "numeric" })}</strong></p>
            </div>
          </div>
        </div>
