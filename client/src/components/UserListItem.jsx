    ...
    return(
         <tr>
              ...
              <td className="actions">
                ...
                <button className="btn delete-btn" title="Delete" onClick={()=>props.onDeleteClick(props.user._id)}>
                ...
                <button className="btn info-btn" title="Info" onClick={() => props.onInfoClick(props.user._id)}>
